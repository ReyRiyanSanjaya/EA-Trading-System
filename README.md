...
> **[✨ VIEW INTERACTIVE DOCUMENTATION](docs/risk_management.html)**  
> Proteksi modal level institusi dengan Circuit Breaker dan Dynamic Sizing.

| Feature | Description | Status |
|---------|-------------|--------|
| **🔌 Circuit Breaker** | Auto-stop trading jika daily drawdown limit tercapai | 🚨 Critical |
| **🌊 Market Regime** | Adaptasi strategi trend vs range secara otomatis | ✅ Active |
| **⚖️ Dynamic Sizing** | Kalkulasi lot otomatis berdasarkan % risiko | ✅ Active |
| **💰 Smart Partial** | Amankan profit bertahap pada level strategis | ✅ Active |
| **📉 Trailing Stop** | Kunci profit mengikuti struktur market (Swing Hi/Lo) | ✅ Active |

<details>
<summary><strong>View Legacy Details</strong></summary>
...
> **[✨ VIEW INTERACTIVE DOCUMENTATION](docs/alerts.html)**  
> Jangan lewatkan signal dengan notifikasi multi-channel (Telegram, Push, Email).

| Feature | Description | Status |
|---------|-------------|--------|
| **✈️ Telegram** | Notifikasi instan ke Channel/Group dengan Chart Screenshot | ✅ Active |
| **📱 Push Notify** | Alert langsung ke HP via MetaTrader Mobile App | ✅ Active |
| **📧 Email** | Laporan signal lengkap ke email untuk dokumentasi | ✅ Active |
| **🔊 Sound** | Audio alert untuk scalping di depan layar | ✅ Active |
...
📁 MQL5/
├── 📁 Experts/
│   └── 📄 trade.mq5                    ← Entry Point (67 lines)
│
└── 📁 Include/
    └── 📁 ESD/                         ← Framework Modules
        │
        │  ══════════════════════════════════════════════════════
        │  🏗️ LAYER 1: FOUNDATION (Types, Config, State, Utils)
        │  ══════════════════════════════════════════════════════
        ├── 📄 ESD_Types.mqh            ← Type definitions & structs
        ├── 📄 ESD_Inputs.mqh           ← User input parameters  
        ├── 📄 ESD_Globals.mqh          ← Global state variables
        ├── 📄 ESD_Utils.mqh            ← Utility functions (NEW)
        ├── 📄 ESD_Visuals.mqh          ← Dashboard & chart objects
        │
        │  ══════════════════════════════════════════════════════
        │  📊 LAYER 2: ANALYSIS (Market Analysis & Detection)
        │  ══════════════════════════════════════════════════════
        ├── 📄 ESD_Trend.mqh            ← Trend analysis
        ├── 📄 ESD_SMC.mqh              ← Smart Money Concepts (51KB)
        ├── 📄 ESD_ML.mqh               ← Machine Learning (68KB)
        ├── 📄 ESD_Risk.mqh             ← Risk & regime detection
        ├── 📄 ESD_Core.mqh             ← Core analysis functions
        ├── 📄 ESD_News.mqh             ← Economic news filter
        │
        │  ══════════════════════════════════════════════════════
        │  ⚡ LAYER 3: EXECUTION (Trade Entry & Management)
        │  ══════════════════════════════════════════════════════
        ├── 📄 ESD_Entry.mqh            ← Entry signal logic
        ├── 📄 ESD_Execution.mqh        ← Trade execution (33KB)
        ├── 📄 ESD_Dragon.mqh           ← Dragon momentum strategy
        ├── 📄 ESD_Confirmation.mqh     ← Advanced confirmations (NEW)
        │
        │  ══════════════════════════════════════════════════════
        │  🎮 CONTROLLER (Manages All Subsystems)
        │  ══════════════════════════════════════════════════════
        └── 📄 ESD_Controller.mqh       ← Central orchestrator (NEW)

📊 Total: 16 modules | ~420KB source code
```
...
> **[✨ VIEW INTERACTIVE DOCUMENTATION](docs/advanced_confirmation.html)**  
> Klik link di atas untuk melihat dokumentasi visual interaktif dengan diagram modern, parameter, dan implementasi kode.

#### Quick Overview

| Feature | Description | Status |
|---------|-------------|--------|
| **📊 Stochastic Filter** | No Buy in Overbought / No Sell in Oversold | ✅ Active |
| **🕯️ Candle Rejection** | Analisis wick-body ratio untuk konfirmasi reversal | ✅ Active |
| **📈 Heatmap & Order Flow** | Multi-timeframe momentum & delta analysis | ✅ Active |
| **⚡ Aggressive FVG** | Entry instant saat FVG fresh terdeteksi (Scalping) | ⚠️ Aggressive |
| **🎯 Inducement Logic** | Trading false breakout di level liquidity (BSL/SSL) | ✅ Active |
| **📉 ML Stochastic** | Entry berbasis ML dengan konfirmasi stoch multi-tf | ✅ Active |

<details>
<summary><strong>📐 View Legacy ASCII Diagrams (Click to Expand)</strong></summary>
...
```
       M5 ────►  ┌────┐  ◄──── 20% weight                    
                 │ +50│                                       
       M15 ───►  ├────┤  ◄──── 30% weight    ──►  STRENGTH   
                 │ +80│                           = +64%      
       H1 ────►  ├────┤  ◄──── 30% weight         (BULLISH)   
                 │ +60│
```

#### 4. ⚡ Aggressive FVG Entry
